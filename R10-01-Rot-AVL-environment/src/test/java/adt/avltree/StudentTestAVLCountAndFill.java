...
public class StudentTestAVLCountAndFill {
	...
	@Test
	public void isAvl() {
		AVLTreeVerifierImpl<Integer> avl = new AVLTreeVerifierImpl(tree1);
		assertTrue(avl.isAVLTree());
		AVLTreeVerifierImpl<Integer> avl2 = new AVLTreeVerifierImpl(tree2);
		assertTrue(avl2.isAVLTree());
		AVLTreeVerifierImpl<Integer> avl3 = new AVLTreeVerifierImpl(tree3);
		assertTrue(avl3.isAVLTree());
	}
}
